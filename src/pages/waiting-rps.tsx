                ...
                >
                    <div className="flex flex-col justify-center items-center  gap-y-2">
                        ...
                        <div className="flex flex-col justify-center text-center gap-y-1">
                            <span className=" text-[#FFCC01]">{currentUser?.username.toUpperCase()}</span>
                            <p className="text-md text-white">
                                <span className="text-success-500">{`${currentUser?.victories}`} </span>
                                Vitorias
                            </p>
                            <p className="text-md text-white">
                                <span className="text-danger-500">{/* {`${currentUser?.defeats}`} */}0 </span>
                                Derrotas
                            </p>
                        </div>
                    </div>
